...
import com.software.financetracker.feature.backup.BackupRestoreScreenRoot
import com.software.financetracker.feature.settings.SettingsScreenRoot
import com.software.financetracker.navigation.BackupRestoreRoute
...
fun NavGraphBuilder.settingsNavGraph(navController: NavController) {
    ...
    composable<BackupRestoreRoute> { BackupRestoreScreenRoot(navController) }
}
