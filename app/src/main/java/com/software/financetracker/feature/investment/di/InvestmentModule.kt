...
import com.software.financetracker.feature.investment.entry.batch.BatchInvestmentEntryViewModel
...
val investmentModule = module {
    viewModel { InvestmentListViewModel(get(), get(), get(), get()) }
    ...
    viewModel { params -> BatchInvestmentEntryViewModel(params.get(), get()) }
}
